...
const AddProductPage = () => {
    ...
    React.useEffect(() => {
        // Cuando el modal está abierto, deshabilitamos el scroll en el body
        document.body.style.overflow = 'hidden';
        
        // Cuando el componente se desmonte o el modal se cierre, reactivamos el scroll
        return () => {
    ...
    if (addProdMutation.isLoading) return <p>loaidin.... </p>



    return (
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 ">
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-auto max-h-[80%] w-[600px] rounded-md overflow-y-auto">
